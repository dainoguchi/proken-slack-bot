...
export const summarizeModalView: View = {
  ...
  blocks: [
    ...
    {
      type: 'input',
      block_id: 'summarize_condition_block',
      element: {
...
export const submitSummarizePrompt = async ({
  ...
  const inputCondition =
    body.view.state.values.summarize_condition_block.plain_text_input_action
      .value
  ...
  const res = await ask(generateSummarizePrompt(inputCondition, inputText))
